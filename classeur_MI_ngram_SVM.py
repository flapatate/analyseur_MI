...
#fichier_corpus = '.\\corpus_de_travail.txt'
fichier_corpus = '.\\corpus_total_COMPLET.txt'


#corpus_entrainement = open('corpus_de_travail.txt', "w", encoding='utf-8')       
#corpus_test = open('corpus_test_20_p_cent_TOP_SECRET.txt', "w", encoding='utf-8')

#fichier_unites_circonscription = '.\\liste_signifiants.txt'
fichier_unites_circonscription = '.\\liste_signifiants_COMPLET.txt'

#fichier_unites_train = '.\\liste_signifiants.txt'
#fichier_unites_train = '.\\liste_signifiants_redux.txt'
#fichier_unites_train = '.\\liste_ambigus.txt'
fichier_unites_train = '.\\liste_signifiants_COMPLET.txt'
#fichier_unites_train = '.\\liste_ambigus_corpus_travail_plus_de_dix.txt'

#fichier_unites_test = '.\\liste_ambigus.txt'
#fichier_unites_test = '.\\liste_signifiants.txt'
#fichier_unites_test = '.\\liste_signifiants_redux.txt'
#fichier_unites_test = '.\\liste_signifiants_COMPLET.txt'
#fichier_unites_test = '.\\liste_ambigus_corpus_travail.txt' 
fichier_unites_test = '.\\liste_ambigus_corpus_travail_plus_de_dix.txt'
#fichier_unites_test = '.\\liste_ambigus_corpus_travail_plus_de_dix_redux.txt'
        ...
        for couple in phrase_combine:
            ...
            if couple[0][0] == 'je_comprends':
                ...
                if couple[1][1] != couple[0][1]:
                    #message(str(sent_tagge))
                    message(str(sent_tagge))
                    #message(str(couple[1][1]))
                    
                    #message(str(couple[0][1]))
...
def analyse_SVM(tranche):
    ...
    #corpus_entrainement_tuple = TaggedCorpusReader(dossier_racine, 'resultats\/corpus_circonscrit.txt') #pour entrainer sur toute
    ...
    #corpus_test_tuple = TaggedCorpusReader(dossier_racine, 'resultats\/corpus_circonscrit.txt') #entrainer sur toute
    ...
    for unite, couple_reponse in zip(liste_dictionnaires_test, double_y):
        ...
        """            
        #IDENT ERREURS#
        if unite['signifiant'] == 'arrête':
            if couple_reponse[0] != couple_reponse[1]:
                message('ERREURS')
                message(str(unite))
                message(str(couple_reponse))
                
                #pour sélectionner les reponses diff de ngram
                #if unite['tag'] != couple_reponse[1]:
                    #message(str(unite))
                    #message(str(couple_reponse))
            else:
